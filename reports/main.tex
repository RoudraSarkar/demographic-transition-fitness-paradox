...
typically from higher- to lower-status individuals \citep{bongaartswatkins1996,cleland2001}.
...
All analyses use R~4.5.1, organised as a numbered-script pipeline supporting reproducibility.
...
marginally. A clear regional pattern is visible: Eastern European countries tend to
have steeper positive gradients, Nordic countries flatter or inverted ones, and Mediterranean
countries a moderate middle, consistent with prior descriptive work \citep{skirbekk2008,andersson2009}
